// CODEX_BIN seam: per-round `codex exec` flags without a per-lane schema field.
// Edit the flags below for the round, then run:
//   CODEX_BIN=scripts/codex-round.ts bun run conductor
